...
// Generates 15-minute time slots for the entire day (e.g., "00:00", "00:15", ..., "23:45")
...
const DailyScheduleGrid: React.FC<DailyScheduleGridProps> = ({
  ...
  // 0 = 00:00, 24 = 06:00, 48 = 12:00, 72 = 18:00
  const [visibleTimeStartIndex, setVisibleTimeStartIndex] = useState(36); // Start at 9 AM (index 36 for 09:00)
    ...
    <div className="overflow-x-auto">
      ...
      <div className="grid grid-cols-[auto_1fr] min-w-full border border-gray-200 dark:border-gray-700 rounded-lg shadow-md bg-white dark:bg-gray-800 relative">
        ...
        <div className="flex-1 overflow-x-hidden">
          {/* Hourly Time Headers */}
          <div className="grid grid-cols-24 border-b border-gray-200 dark:border-gray-700"> {/* 24 columns for 6 hours (4x15min per hour) */}
                  ...
                  if (bookingToRender) {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          left: `${(index / 24) * 100}%`, // Position based on its start index in visible slots
                          width: `${(colSpan / 24) * 100}%`, // Width based on its span relative to visible slots
                          zIndex: 10,
                    ...
                    return (
                      <div
                        ...
                        style={{ gridColumn: `span 1` }} // Each empty slot is 15 minutes
                      >
